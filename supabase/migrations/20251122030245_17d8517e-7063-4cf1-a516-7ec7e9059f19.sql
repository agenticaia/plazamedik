-- Update auto_create_po_at_reorder_point to send email notification for critical POs
    ...
    IF NEW.cantidad_stock <= (NEW.ai_reorder_point * 0.5) THEN
      BEGIN
        ...
        PERFORM net.http_post(
          url := (SELECT current_setting('app.settings.supabase_url', true)) || '/functions/v1/notify-critical-po',
        ...
        RAISE NOTICE '📧 Email notification sent for critical PO %', v_po_number;
      EXCEPTION
        WHEN OTHERS THEN
