...
export const TestDialog = ({ open, onOpenChange }: TestDialogProps) => {
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label>Sexo</Label>
                  <RadioGroup value={testData.gender} onValueChange={(value) => setTestData({ ...testData, gender: value })}>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="other" className="font-normal cursor-pointer">Prefiero no decirlo</Label>
                    </div>
                  </RadioGroup>
                </div>
                ...
                <div>
                  ...
                  <RadioGroup value={testData.workType} onValueChange={(value) => setTestData({ ...testData, workType: value })}>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="health" id="health" />
                      <Label htmlFor="health" className="font-normal cursor-pointer">Enfermería / personal de salud</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="retail" id="retail" />
                      <Label htmlFor="retail" className="font-normal cursor-pointer">Retail (tienda, cajera, supermercado)</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="beauty" id="beauty" />
                      <Label htmlFor="beauty" className="font-normal cursor-pointer">Belleza (peluquería, barbería, estética)</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="service" id="service" />
                      <Label htmlFor="service" className="font-normal cursor-pointer">Restaurantes / hoteles / servicios</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="other" id="work-other" />
                      <Label htmlFor="work-other" className="font-normal cursor-pointer">Otro trabajo de pie</Label>
                    </div>
                  </RadioGroup>
                </div>
                ...
                <div>
                  ...
                  <RadioGroup value={testData.hoursStanding} onValueChange={(value) => setTestData({ ...testData, hoursStanding: value })}>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="<4" id="hours1" />
                      <Label htmlFor="hours1" className="font-normal cursor-pointer">Menos de 4 horas</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="4-8" id="hours2" />
                      <Label htmlFor="hours2" className="font-normal cursor-pointer">Entre 4 y 8 horas</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="8-10" id="hours3" />
                      <Label htmlFor="hours3" className="font-normal cursor-pointer">Entre 8 y 10 horas</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="10+" id="hours4" />
                      <Label htmlFor="hours4" className="font-normal cursor-pointer">Más de 10 horas</Label>
                    </div>
                  </RadioGroup>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <RadioGroup value={testData.legFeeling} onValueChange={(value) => setTestData({ ...testData, legFeeling: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="light" id="light" />
                    <Label htmlFor="light" className="font-normal cursor-pointer">Ligeras, casi sin molestias</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="tired" id="tired" />
                    <Label htmlFor="tired" className="font-normal cursor-pointer">Cansadas y pesadas</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="painful" id="painful" />
                    <Label htmlFor="painful" className="font-normal cursor-pointer">Dolorosas o con sensación de "ardor"</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="cramps" id="cramps" />
                    <Label htmlFor="cramps" className="font-normal cursor-pointer">Siento calambres o pinchazos</Label>
                  </div>
                </RadioGroup>
              </div>
                ...
                <div className="space-y-2 mt-2">
                  {[
                    ...
                    <div key={sign.id} className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor={sign.id} className="font-normal cursor-pointer">{sign.label}</Label>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <RadioGroup value={testData.symptomFrequency} onValueChange={(value) => setTestData({ ...testData, symptomFrequency: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="never" id="freq1" />
                    <Label htmlFor="freq1" className="font-normal cursor-pointer">Casi nunca</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="1-2" id="freq2" />
                    <Label htmlFor="freq2" className="font-normal cursor-pointer">1–2 veces por semana</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="3-5" id="freq3" />
                    <Label htmlFor="freq3" className="font-normal cursor-pointer">3–5 veces por semana</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="daily" id="freq4" />
                    <Label htmlFor="freq4" className="font-normal cursor-pointer">Todos los días</Label>
                  </div>
                </RadioGroup>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <RadioGroup value={testData.familyHistory} onValueChange={(value) => setTestData({ ...testData, familyHistory: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="no" id="fam-no" />
                    <Label htmlFor="fam-no" className="font-normal cursor-pointer">No</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="yes" id="fam-yes" />
                    <Label htmlFor="fam-yes" className="font-normal cursor-pointer">Sí</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div>
                ...
                <RadioGroup value={testData.circulation} onValueChange={(value) => setTestData({ ...testData, circulation: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="no" id="circ-no" />
                    <Label htmlFor="circ-no" className="font-normal cursor-pointer">No</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="yes" id="circ-yes" />
                    <Label htmlFor="circ-yes" className="font-normal cursor-pointer">Sí</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div>
                ...
                <RadioGroup value={testData.pregnancy} onValueChange={(value) => setTestData({ ...testData, pregnancy: value })}>
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="preg-1" className="font-normal cursor-pointer">Sí, una vez</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="2+" id="preg-2" />
                    <Label htmlFor="preg-2" className="font-normal cursor-pointer">Sí, dos o más veces</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div>
                ...
                <RadioGroup value={testData.overweight} onValueChange={(value) => setTestData({ ...testData, overweight: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="no" id="weight-no" />
                    <Label htmlFor="weight-no" className="font-normal cursor-pointer">No</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="yes" id="weight-yes" />
                    <Label htmlFor="weight-yes" className="font-normal cursor-pointer">Sí</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="unsure" id="weight-unsure" />
                    <Label htmlFor="weight-unsure" className="font-normal cursor-pointer">No estoy segur@</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div>
                ...
                <RadioGroup value={testData.smoking} onValueChange={(value) => setTestData({ ...testData, smoking: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="never" id="smoke-never" />
                    <Label htmlFor="smoke-never" className="font-normal cursor-pointer">No, nunca</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="ex" id="smoke-ex" />
                    <Label htmlFor="smoke-ex" className="font-normal cursor-pointer">Soy exfumador(a)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="<10" id="smoke-light" />
                    <Label htmlFor="smoke-light" className="font-normal cursor-pointer">Sí, menos de 10 cigarrillos al día</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="10+" id="smoke-heavy" />
                    <Label htmlFor="smoke-heavy" className="font-normal cursor-pointer">Sí, más de 10 al día</Label>
                  </div>
                </RadioGroup>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <RadioGroup value={testData.canSit} onValueChange={(value) => setTestData({ ...testData, canSit: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="always" id="sit-always" />
                    <Label htmlFor="sit-always" className="font-normal cursor-pointer">Casi siempre</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="sometimes" id="sit-sometimes" />
                    <Label htmlFor="sit-sometimes" className="font-normal cursor-pointer">A veces</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="never" id="sit-never" />
                    <Label htmlFor="sit-never" className="font-normal cursor-pointer">Casi nunca</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div>
                ...
                <RadioGroup value={testData.footwear} onValueChange={(value) => setTestData({ ...testData, footwear: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="sneakers" id="shoe1" />
                    <Label htmlFor="shoe1" className="font-normal cursor-pointer">Zapatillas cómodas</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="low-heel" id="shoe2" />
                    <Label htmlFor="shoe2" className="font-normal cursor-pointer">Zapatos cerrados con poco taco</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="heel" id="shoe3" />
                    <Label htmlFor="shoe3" className="font-normal cursor-pointer">Zapatos con taco medio o alto</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="flat" id="shoe4" />
                    <Label htmlFor="shoe4" className="font-normal cursor-pointer">Sandalias / calzado muy plano</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div>
                ...
                <RadioGroup value={testData.usedCompression} onValueChange={(value) => setTestData({ ...testData, usedCompression: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="never" id="comp-never" />
                    <Label htmlFor="comp-never" className="font-normal cursor-pointer">No, nunca</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="sometimes" id="comp-sometimes" />
                    <Label htmlFor="comp-sometimes" className="font-normal cursor-pointer">Sí, pero no las uso siempre</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="daily" id="comp-daily" />
                    <Label htmlFor="comp-daily" className="font-normal cursor-pointer">Sí, y las uso casi todos los días</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div>
                ...
                <RadioGroup value={testData.concern} onValueChange={(value) => setTestData({ ...testData, concern: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="little" id="concern1" />
                    <Label htmlFor="concern1" className="font-normal cursor-pointer">Poco, casi no lo pienso</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="some" id="concern2" />
                    <Label htmlFor="concern2" className="font-normal cursor-pointer">Algo, pero no he hecho nada aún</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="seeking" id="concern3" />
                    <Label htmlFor="concern3" className="font-normal cursor-pointer">Mucho, y estoy buscando soluciones</Label>
                  </div>
                </RadioGroup>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <RadioGroup value={testData.treatment} onValueChange={(value) => setTestData({ ...testData, treatment: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="none" id="treat-none" />
                    <Label htmlFor="treat-none" className="font-normal cursor-pointer">No, ninguno</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="injection" id="treat-inj" />
                    <Label htmlFor="treat-inj" className="font-normal cursor-pointer">Sí, inyecciones (esclerosis)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="laser" id="treat-laser" />
                    <Label htmlFor="treat-laser" className="font-normal cursor-pointer">Sí, láser u otro procedimiento</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="unsure" id="treat-unsure" />
                    <Label htmlFor="treat-unsure" className="font-normal cursor-pointer">Sí, pero no recuerdo el nombre</Label>
                  </div>
                </RadioGroup>
              </div>
                  ...
                  {[
                    ...
                    <div key={careItem.id} className="flex items-center space-x-2">
                      <input
                        ...
                        className="w-4 h-4 rounded border-input"
                      />
                      <Label htmlFor={careItem.id} className="font-normal cursor-pointer">{careItem.label}</Label>
                    </div>
                  ))}
                </div>
              </div>
  ...
  const renderResult = () => {
    ...
    const resultData = {
      LEVE: {
        title: "RIESGO LEVE",
        description: "Según tus respuestas, es posible que presentes una insuficiencia venosa leve. Tus venas ya están empezando a resentir las horas de pie, pero estamos en una fase en la que es mucho más fácil prevenir que lamentar.",
        recommendations: [
        ...
        products: [
          "Calcetines hasta rodilla 12–17 mmHg – Talón, puntera y plantilla reforzados"
        ]
      },
      MODERADO: {
        title: "RIESGO MODERADO",
        description: "Según tus respuestas, es posible que presentes una insuficiencia venosa moderada. Tus venas ya están mostrando signos más evidentes del esfuerzo de trabajar de pie muchas horas. Es importante que actúes cuanto antes para evitar que el problema avance.",
        recommendations: [
      ...
      AVANZADO: {
        ...
        description: "Según tus respuestas, es posible que presentes una insuficiencia venosa avanzada. Tus venas y tus piernas están sufriendo de manera importante el efecto de las horas de pie. Es muy importante que pidas cita con tu médico o especialista vascular lo antes posible.",
        recommendations: [
      ...
      <div className="space-y-6 max-h-[60vh] overflow-y-auto">
        <div className="text-center">
          <h3 className="text-2xl font-bold text-primary mb-2">
            Resultado de tu Test: {data.title}
          </h3>
