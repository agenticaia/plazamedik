...
const WhatsAppFloat = () => {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 bg-whatsapp-green hover:bg-whatsapp-green/90 text-white p-5 rounded-full shadow-hover transition-all hover:scale-110 group"
